...
const API_KEY = process.env.GEMINI_API_KEY_PAID || process.env.GEMINI_API_KEY;
const MODEL = "gemini-1.5-pro-latest"; // user requested gemini-pro-latest

if (!API_KEY) {
    console.log("No GEMINI_API_KEY_PAID or GEMINI_API_KEY found in ENV! Exiting.");
    process.exit(1);
}
